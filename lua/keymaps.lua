...
map("n", "<c-/>",      function() Snacks.terminal(nil, { cwd = vim.fn.getcwd() }) end, { desc = "Terminal (CWD)" })
map("n", "<c-_>",      function() Snacks.terminal(nil, { cwd = vim.fn.getcwd() }) end, { desc = "which_key_ignore" })
map('t', '<C-q>', [[<C-\><C-n>]], opts) -- Exit insert mode 
...
map('n', '<leader>fm', builtin.keymaps, {desc = 'Find keymaps'})
